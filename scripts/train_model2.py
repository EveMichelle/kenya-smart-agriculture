"""scripts/train_model2.py — Train food price forecasting model (KNBS CPI + NASA)"""
import sys, os
...
def main():
    ...
    print("  Algorithm: ARIMA baseline → Facebook Prophet")
    print("  Target   : Monthly KNBS CPI Food Index")
    print("="*55)
    ...
    print(f"\n  CPI series: {len(series)} months ({series.index.min()} → {series.index.max()})")
